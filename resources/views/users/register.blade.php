<x-layout>
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <form method="POST" action="/users"class="mx-auto max-w-lg rounded-lg border">
                @csrf
                <div class="flex flex-col gap-4 p-4 md:p-8">
                    <div>
                        ...
                        <input name="name"
                            ...
                            value="{{ old('name') }}" />
                        @error('name')
                            <lord-icon src="https://cdn.lordicon.com/ygvjgdmk.json" trigger="loop" delay="200"
                                colors="primary:#ff0000" style="width:25px;height:25px">
                            </lord-icon>
                    ...
                    <div>
                        <label for="password_confirmation"
                            class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Confirm
                            password</label>
                    ...
                    <button
                        class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Register</button>
                    ...
                    <div class="flex items-center justify-center bg-gray-100 p-4">
                        <p class="text-center text-sm text-gray-500">Already have an account? <a href="login"
                                class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">Log
                                in</a>
                        </p>
                    </div>
            </form>
