...
<body>
    ...
    <div class="bg-bg pb-6 sm:pb-8 lg:pb-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <header class="mb-4 flex items-center justify-between py-4 md:mb-4 md:py-4 xl:mb-16">
                <a href="/" class="inline-flex items-center w-48 text-2xl font-bold text-black md:text-3xl"
                    aria-label="logo">
                    <img src="{{ asset('logo.png') }}" alt="CoffeeSeek">
                </a>
                <nav class="hidden gap-2 lg:flex">
                    <a href="/" class="text-lg font-semibold text-black w-32">
                ...
                <button type="button"
                    class="inline-flex items-center gap-2 rounded-lg bg-gray-200 px-2.5 py-2 text-sm font-semibold text-gray-500 ring-primary-300 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base lg:hidden">
